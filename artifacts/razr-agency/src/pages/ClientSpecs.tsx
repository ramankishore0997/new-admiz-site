        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm flex items-center justify-between">
            <div>
              ...
              <div className="text-2xl font-black text-slate-900 mt-0.5">14 Ready</div>
            ...
            <div className="w-12 h-12 rounded-xl bg-blue-50 border border-blue-200 flex items-center justify-center text-[#1877F2]">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm flex items-center justify-between">
            <div>
              ...
              <div className="text-2xl font-black text-slate-900 mt-0.5">8 Ready</div>
              <div className="text-[10px] font-bold text-emerald-600 mt-1 flex items-center gap-1">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm flex items-center justify-between">
            <div>
              ...
              <div className="text-2xl font-black text-slate-900 mt-0.5">6 Ready</div>
              <div className="text-[10px] font-bold text-emerald-600 mt-1 flex items-center gap-1">
