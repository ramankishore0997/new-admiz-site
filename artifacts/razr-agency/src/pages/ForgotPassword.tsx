          ...
          <div className="relative group rounded-3xl overflow-hidden border border-slate-200 bg-white p-8 shadow-xl shadow-slate-200/60">
            ...
            {submitted ? (
              <div className="text-center py-6 space-y-6">
                ...
                <div>
                  <h3 className="text-2xl font-black uppercase tracking-tight text-slate-900">Request Submitted</h3>
                ...
                <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full border border-emerald-200 bg-emerald-50">
                  <CheckCircle2 className="w-3.5 h-3.5 text-emerald-600" />
                  <span className="text-[9px] font-black tracking-widest text-emerald-700 uppercase">Under Review</span>
                </div>
                <Link
                  href="/login"
              ...
              <div className="space-y-6">
                <div className="text-center">
                  ...
                  <p className="text-xs text-slate-500">Enter your email and the new password you want to use</p>
                </div>
